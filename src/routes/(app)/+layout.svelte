...
<div class="drawer">
	...
	<div class="drawer-content flex flex-col">
	  <!-- Navbar -->
	  <div class="w-full navbar bg-transparent absolute top-0 left-0 z-5">
		<div class="ml-2 flex-none lg:hidden">
		  <label for="my-drawer-3" aria-label="open sidebar" class="btn btn-sm btn-ghost hover:text-primary hover:scale-105 duration-300">
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-6 h-6 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>
		  </label>
		</div> 
		<div class="navbar-start pl-2">
			<a href="/" class="font-['The_Nautigal'] lg:ml-2 btn btn-circle btn-ghost hover:bg-transparent hover:text-primary hover:scale-105 duration-300 text-2xl">MS</a>
		</div>
		...
		<div class="navbar-end">
			<a class="btn btn-ghost btn-sm mr-2 hover:text-primary hover:scale-105 duration-300" href="https://dub.sh/eyj5LqY" target="_blank" rel="noopener noreferrer">
