...
<section class="p-8 flex flex-col items-center">
    ...
    <div class="card p-8 gap-4 max-w-sm md:max-w-md lg:max-w-xl xl:max-w-3xl bg-base-100 shadow-lg shadow-neutral hover:shadow-primary hover:scale-[102%] duration-300">
        ...
        <p class="text-justify text-sm sm:text-md">Using modern technologies to solve modern problems. My specialty is fullstack development but I love learning new technology. I'm passionate about privacy, security, cryptocurrency, productivity, fitness, and reading. If that sounds like you, check out my blog or reach out to connect.</p>
